...
document.onreadystatechange=function(){if(document.readyState=="complete"){var fa=document.createElement('link');fa.rel='stylesheet';fa.href='https://pouyacode.net/theme/css/font-awesome.min.css?v=0';fa.type='text/css';var fa_defer=document.getElementsByTagName('link')[0];fa_defer.parentNode.insertBefore(fa,fa_defer);try{let rot13=document.getElementById('email').href.replace(/[a-zA-Z]/g,function(c){return String.fromCharCode((c<="Z"?90:122)>=(c=c.charCodeAt(0)+13)?c:c-26);});document.getElementById('email').href=rot13;let subject=document.getElementsByClassName('article-title')[0].innerHTML;subject=subject.substr(subject.search('&nbsp')+6);rot13+='?subject='+subject;document.getElementById('feedback').innerHTML='<a href="'+rot13+'"><i class="fas fa-at"></i>&nbsp;Send feedback</a>';}catch(_){}}};